...
My research interests are in system security and computer architecture. In particular, I enjoy re-evaluating the rationale behind certain hardware designs, and uncovering new side-channel leakages to offer designers insights for building more secure systems. During my PhD, I identified several interrupt side channels [HPCA'24, DAC'24, TIFS'25, ISCA'26A] and power side channels [DAC'25 x2, TCAD'25, ISCA'26B]. I have also devoted additional time to collaborative projects spanning computer architecture and applied cryptography.
